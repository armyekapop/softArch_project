  ...
  const VerifyOTP= ({navigation}) => {
    ...
    return (
      ...
      <View style={{flex: 1}} className='bg-green-regis'>
        <View style={{flex: 4}} className=' object-center w-full rounded-b-xl  bg-green-regis container'>

            <View className=" w-full h-full  justify-between items-center ">
                <Image source={logo} className="w-32 h-32"/>
                <Text style={{fontFamily: "NotoSans-Bold"}} className="text-3xl text-egg">Please Enter OTP PIN</Text>
